                                                ...
                                                <div class="dropdown pull-right">
                                                    <button class="btn btn-default dropdown-toggle" type="button" id="menu1" data-toggle="dropdown">Action
                                                        ...
                                                        <ul class="dropdown-menu" role="menu" aria-labelledby="menu1">
                                                            @if ($applicant->status)
                                                                <li role="presentation"><a href="{{route('dept.applicant.unapprove', $applicant->id)}}"> Unapproved</a></li>
                                                            @else
                                                                <li role="presentation"><a href="{{route('dept.applicant.approve', $applicant->id)}}"> Approved</a></li>
                                                            @endif
                                                            <li role="presentation" class="divider"></li>
                                                            <li role="presentation"><a href="{{route('dept.applicant.show', $applicant->id)}}"> Show</a></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </td>
