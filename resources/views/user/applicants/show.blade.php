                            ...
                            <tr>
                                <td colspan="2">
                                    <div class="pull-right">
                                        @if ($applicant->status)
                                            <a class="btn btn-danger" href="{{ route('dept.applicant.unapprove',$applicant->id) }}">Unapproved</a>
                                        @else
                                            <a class="btn btn-success" href="{{ route('dept.applicant.approve',$applicant->id) }}">Approved</a>
                                        @endif

                                        @if ($prev_id)
                                            <a class="btn btn-primary" href="{{ route('dept.applicant.show',$prev_id) }}"><< Applicants</a>
                                        @endif
                                        @if ($next_id)
                                            <a class="btn btn-primary" href="{{ route('dept.applicant.show',$next_id) }}">Applicants >></a>
                                        @endif
                                    </div>
                                </td>
                            </tr>
